...
def main():
    ...
    img = pygame.image.load(
        os.path.join(os.path.dirname(os.path.abspath(__file__)), "Red_Square.png")
    )
    ...
    static = [
        ...
        pymunk.Segment(space.static_body, (350, 150), (410, 150), 3),
        pymunk.Segment(space.static_body, (440, 200), (500, 200), 3),
        pymunk.Segment(space.static_body, (530, 250), (580, 250), 3),
    ]
    # static[1].color = pygame.Color("red")
    # static[2].color = pygame.Color("white")
    ...
    passthrough.color = pygame.Color("white")
    ...
    while running:
        ...
        for event in pygame.event.get():
            if (
                ...
                pygame.image.save(screen, "elon.png")
